...
Eel is not as fully-fledged as Electron or cefpython - it is probably not suitable for making full blown 
...
This will start a webserver on the default settings (http://localhost:8000) and 
