...
set_target_properties(opencv_flann PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_flann2413d.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_flann2413d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_flann )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_flann "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_flann2413d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_flann2413d.dll" )
...
set_target_properties(opencv_features2d PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_features2d2413d.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_features2d2413d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_features2d )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_features2d "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_features2d2413d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_features2d2413d.dll" )
...
set_target_properties(opencv_calib3d PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_calib3d2413d.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_calib3d2413d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_calib3d )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_calib3d "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_calib3d2413d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_calib3d2413d.dll" )
...
set_target_properties(opencv_ml PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_ml2413d.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_ml2413d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_ml )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ml "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_ml2413d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_ml2413d.dll" )
...
set_target_properties(opencv_legacy PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_legacy2413d.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_legacy2413d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_legacy )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_legacy "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_legacy2413d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_legacy2413d.dll" )
...
set_target_properties(opencv_objdetect PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_objdetect2413d.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_objdetect2413d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_objdetect )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_objdetect "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_objdetect2413d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_objdetect2413d.dll" )
...
set_target_properties(opencv_photo PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_photo2413d.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_photo2413d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_photo )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_photo "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_photo2413d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_photo2413d.dll" )
...
set_target_properties(opencv_gpu PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_gpu2413d.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_gpu2413d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_gpu )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_gpu "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_gpu2413d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_gpu2413d.dll" )
...
set_target_properties(opencv_ocl PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_ocl2413d.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_ocl2413d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_ocl )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ocl "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_ocl2413d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_ocl2413d.dll" )
...
set_target_properties(opencv_nonfree PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_nonfree2413d.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_nonfree2413d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_nonfree )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_nonfree "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_nonfree2413d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_nonfree2413d.dll" )
...
set_target_properties(opencv_contrib PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_contrib2413d.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_contrib2413d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_contrib )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_contrib "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_contrib2413d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_contrib2413d.dll" )
...
set_target_properties(opencv_stitching PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_stitching2413d.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_stitching2413d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_stitching )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_stitching "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_stitching2413d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_stitching2413d.dll" )
...
set_target_properties(opencv_ts PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_ts2413d.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_ts )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ts "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_ts2413d.lib" )
...
set_target_properties(opencv_videostab PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_videostab2413d.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_videostab2413d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_videostab )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_videostab "${_IMPORT_PREFIX}/x86/vc14/lib/opencv_videostab2413d.lib" "${_IMPORT_PREFIX}/x86/vc14/bin/opencv_videostab2413d.dll" )
